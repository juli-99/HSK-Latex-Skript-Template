...
%--- Grafiken -----------------------------------------------------------------
\usepackage{graphicx}
\graphicspath{{../Resources/Pictures/}} % alle Bilder liegen hier; Angabe im Text ohne "Resources/Pictures/"
...
%
%  Der Dateiname wird ohne Endung und ohne "Resources/Pictures/" angegeben.
